...
struct VkDeviceAllocatorCreateInfo {
    ...
    bool enableDefragmentation = false;         // Defragmentation support (NOT IMPLEMENTED, BECAUSE WE DON'T NEED)
    bool enableHostMapping = true;              // Support for memory mapping
    bool trackLeaks = true;                     // Track memory leaks in debug mode
    ThreadSafetyMode threadSafetyMode = ThreadSafetyMode::FINE_GRAINED;  // Thread safety option
