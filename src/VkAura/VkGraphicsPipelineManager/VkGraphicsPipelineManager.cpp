...
void VkGraphicsPipelineManager::createPipeline(VkRenderPass renderPass, VkExtent2D extent)
{
    ...
    // VkPipelineDepthStencilStateCreateInfo depthStencilState; // Can be used
...
void VkGraphicsPipelineManager::cmdBindPipeline(VkCommandBuffer commandBuffer)
{
    vkCmdBindPipeline(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, _pipeline);
}

void VkGraphicsPipelineManager::cmdDraw(VkCommandBuffer commandBuffer, VkExtent2D extent)
{
    VkViewport viewport = {};
    viewport.x = 0.0f;
    viewport.y = 0.0f;
